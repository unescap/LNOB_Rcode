...
### For now only MICS6 has collected disability information for men and women of age 18-49.
### DHS data is not included.

source(paste(r_folder,"MICS_main_functions.R",sep=""))
source(paste(r_folder,"MICS_get_data_disability.R",sep="")) ### overwrites the normal get data functions
#### running MICS:
