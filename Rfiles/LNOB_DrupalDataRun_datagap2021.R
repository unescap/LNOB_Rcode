...
indicator_selection<-list(dataSet=c("IR"), IndList=c("ProfessionalHelp"))
...
indicator_selection<-list(dataSet=c( "HR"), IndList=c("AccessElectricity"))
...
indicator_selection<-list(dataSet=c("hh"), IndList=c("AccessElectricity"))
...
indicator_selection<-list(dataSet=c("IR", "wm", "HR", "hh"), IndList=c("ProfessionalHelp", "CleanFuel", "AccessElectricity"))
