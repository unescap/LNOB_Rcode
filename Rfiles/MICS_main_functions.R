...
# available_data_names <- list.files(path = paste(source_folder,"sav_download",sep=""))
# 
# available_data_names <- "Bhutan2010"
# 
...
#   split_code <- strsplit(name, split = "(?<=[a-zA-Z])\\s*(?=[0-9])", perl = TRUE)
# 
#   country_code <- unlist(split_code)[1]
#   version_code <- unlist(split_code)[2]
#   
...
#   run_together_edu(csv_folder, data_folder, temp_output_folder, 
#                                             country_code, version_code,  csvfile_name)
#   run_together(csv_folder, data_folder, temp_output_folder, 
#                                             country_code, version_code, csvfile_name)
#   
# }
...
### contraceptive debugging
# run_together(csv_folder, data_folder, output_folder, "Kyrgyzstan", "2018",  csvfile_name, edcationcsv)
# run_together(csv_folder, data_folder, output_folder, "Kyrgyzstan", "2014",  csvfile_name, edcationcsv)  #no mics summary data
# run_together(csv_folder, data_folder, output_folder, "Kazakhstan", "2015",  csvfile_name, edcationcsv)
# run_together(csv_folder, data_folder, output_folder, "Turkmenistan", "2015",  csvfile_name, edcationcsv)
...
### covid
# done
# sink(file=paste(output_folder, "log.txt", sep=""))
...
# run_together(csv_folder, data_folder, output_folder, "Bhutan", "2010",  csvfile_name, edcationcsv, religioncsv, religion = TRUE)
...
# run_together(csv_folder, data_folder, output_folder, "Turkmenistan", "2015",  csvfile_name, edcationcsv, religioncsv, religion = TRUE)
 ...
 # run_together(csv_folder, data_folder, output_folder, "Thailand", "2015",  csvfile_name, edcationcsv)
 # run_together(csv_folder, data_folder, output_folder, "Thailand", "2015",  csvfile_name, edcationcsv, religioncsv, religion = TRUE)

#  run_together(csv_folder, data_folder, output_folder, "Thailand", "2015",  csvfile_name, edcationcsv, region_flag = TRUE)
#  run_together(csv_folder, data_folder, output_folder, "Thailand", "2015",  csvfile_name, edcationcsv, religioncsv, religion = TRUE, region_flag = TRUE)
# 
# 
...
# # run_together(csv_folder, data_folder, output_folder, "Vanuatu", "2007",  csvfile_name, edcationcsv)
 # run_together(csv_folder, data_folder, output_folder, "Vietnam", "2010",  csvfile_name, edcationcsv)
#  run_together(csv_folder, data_folder, output_folder, "VietNam", "2013",  csvfile_name, edcationcsv)
